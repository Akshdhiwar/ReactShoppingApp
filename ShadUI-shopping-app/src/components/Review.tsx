  ...
  return (
    <ul className="md:columns-2 lg:columns-3 xl:columns-4 space-y-4 md:space-y-6 md:gap-6 mx-auto">
        ...
        [1, 2, 3, 4, 5, 6, 7, 8].map((e) => {
          return (
            <li className="break-inside-avoid" key={e}>
              <figure className="relative h-full shadow-xl w-full max-w-[500px] p-6 rounded-xl border border-primary/50 bg-base-100 ">
                {
      ...
      <li className="break-inside-avoid">
        <figure className="relative h-full w-full max-w-[500px] p-6 rounded-xl border border-primary/50 bg-base-100 hover:shadow-sm">
